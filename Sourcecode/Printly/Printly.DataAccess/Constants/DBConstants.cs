namespace Printly.DataAccess.Constants
{
    ...
    internal class DBColumnConstants
    {
        ...
        internal const string PRODUCTCATEGORYCODE = "ProductCategoryCode";
        internal const string PRODUCTCATEGORYPARENTID = "ProductCategoryParentID";
        internal const string PRODUCTCATEGORYPARENTS = "ProductCategoryParents";
